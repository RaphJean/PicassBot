...
from picassbot.policy.model import ConvBlock  # Ton code existant
from picassbot.policy.predictor import LatentPredictor # Ton code existant
...
class FullAgent(nn.Module):
    def __init__(self, action_dim=2, hidden_dim=512, predictor_hidden_dim=256):
        super().__init__()
